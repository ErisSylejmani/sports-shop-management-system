...
namespace backend.Migrations
{
    ...
    [Migration("20260521150247_LinkApplicationUserPunetor")]
    partial class LinkApplicationUserPunetor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasIndex("PunetorId")
                        .IsUnique()
                        .HasFilter("[PunetorId] IS NOT NULL");
            ...
            modelBuilder.Entity("backend.Data.ApplicationUser", b =>
                {
                    b.HasOne("backend.Data.Punetor", "Punetor")
                        .WithOne()
                        .HasForeignKey("backend.Data.ApplicationUser", "PunetorId")
